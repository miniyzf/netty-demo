    ...
    return function e(t, n, r) {
        ...
        13: [function (e, t, n) {
            (function (n) {
                ...
                var o = e("./transports"), a = e("component-emitter"), s = e("debug")("engine.io-client:socket"),
                    c = e("indexof"), d = e("engine.io-parser"), u = e("parseuri"), p = e("parsejson"),
                    f = e("parseqs");
        ...
        16: [function (e, t, n) {
            (function (n) {
                ...
                a(i, o), i.prototype.supportsBinary = !1, i.prototype.doClose = function () {
                    ...
                    var i = this;
                    if (!this.form) {
                        var o, a = document.createElement("form"), s = document.createElement("textarea"),
        ...
        17: [function (e, t, n) {
            (function (n) {
                ...
                var s = e("xmlhttprequest"), c = e("./polling"), d = e("component-emitter"), u = e("component-inherit"),
        ...
        18: [function (e, t, n) {
            ...
            var i = e("../transport"), o = e("parseqs"), a = e("engine.io-parser"), s = e("component-inherit"),
        ...
        19: [function (e, t, n) {
            ...
            var i = e("../transport"), o = e("engine.io-parser"), a = e("parseqs"), s = e("component-inherit"),
                c = e("debug")("engine.io-client:websocket"), d = e("ws");
        ...
        24: [function (e, t, n) {
            (function (t) {
                ...
                var c = e("./keys"), d = e("has-binary"), u = e("arraybuffer.slice"), p = e("base64-arraybuffer"),
                    f = e("after"), l = e("utf8"), h = navigator.userAgent.match(/Android/i),
                    m = /PhantomJS/i.test(navigator.userAgent), g = h || m;
                n.protocol = 3;
                var v = n.packets = {open: 0, close: 1, ping: 2, pong: 3, message: 4, upgrade: 5, noop: 6}, y = c(v),
                    w = {type: "error", data: "parser error"}, b = e("blob");
        ...
        26: [function (e, t, n) {
            ...
            a.inherits(r, o), r.prototype.send = function (e, t) {
                ...
                var r = "number" != typeof t.bufferedAmountLowThreshold, i = 0, o = function () {
        ...
        27: [function (e, t, n) {
            ...
            t.exports = function (e, t) {
                ...
                if (window.navigator.userAgent.match("Chrome")) {
                    var s = parseInt(window.navigator.userAgent.match(/Chrome\/(.*) /)[1], 10), c = 33,
        ...
        28: [function (e, t, n) {
            e("webrtc-adapter");
            t.exports = function (e, t) {
                var n, r = 2 === arguments.length, i = {video: !0, audio: !0}, o = "PermissionDeniedError",
                    a = "PERMISSION_DENIED", s = "ConstraintNotSatisfiedError";
        ...
        30: [function (e, t, n) {
            ...
            !function () {
                ...
                var i = e("./chrome/chrome_shim") || null, o = e("./edge/edge_shim") || null,
                    a = e("./firefox/firefox_shim") || null, s = e("./safari/safari_shim") || null;
                switch (r.browser) {
                    case"opera":
                    case"chrome":
                    ...
                    window.RTCIceGatherer && (window.RTCIceCandidate || (window.RTCIceCandidate = function (e) {
                        ...
                        if ("offer" === e.type) this._pendingOffer && (t = r.splitSections(e.sdp), n = t.shift(), t.forEach(function (e, t) {
                            ...
                            t.forEach(function (e, t) {
                                var a = i.transceivers[t], s = a.iceGatherer, c = a.iceTransport, d = a.dtlsTransport,
                                    u = a.localCapabilities, p = a.remoteCapabilities,
                                    f = "0" === e.split("\n", 1)[0].split(" ", 2)[1];
                                if (!f) {
                        ...
                        var t = this, n = new MediaStream, i = [], o = r.splitSections(e.sdp), a = o.shift(),
                        ...
                        switch (this.usingBundle = r.matchPrefix(a, "a=group:BUNDLE ").length > 0, o.forEach(function (o, c) {
                            var d, u, p, f, l, h, m, g, v, y, w, b, C = r.splitLines(o), S = C[0].substr(2).split(" "),
                                k = S[0], T = "0" === S[1], E = r.getDirection(o, a), P = r.parseRtpParameters(o);
                            ...
                            if ("offer" !== e.type || T) "answer" !== e.type || T || (d = t.transceivers[c], u = d.iceGatherer, p = d.iceTransport, f = d.dtlsTransport, l = d.rtpSender, h = d.rtpReceiver, m = d.sendEncodingParameters, v = d.localCapabilities, t.transceivers[c].recvEncodingParameters = g, t.transceivers[c].remoteCapabilities = P, t.transceivers[c].cname = R, (s || D) && j.length && p.setRemoteCandidates(j), t.usingBundle && 0 !== c || (p.start(u, w, "controlling"), f.start(b)), t._transceive(d, "sendrecv" === E || "recvonly" === E, "sendrecv" === E || "sendonly" === E), !h || "sendrecv" !== E && "sendonly" !== E ? delete d.rtpReceiver : (y = h.track, i.push([y, h]), n.addTrack(y))); else {
                        ...
                        n.forEach(function (t, n) {
                            var i, o, a = t.track, c = t.kind, d = r.generateIdentifier(),
                                u = e.usingBundle && n > 0 ? {
                                    iceGatherer: s[0].iceGatherer,
                                    iceTransport: s[0].iceTransport,
                                    dtlsTransport: s[0].dtlsTransport
                                } : e._createIceAndDtlsTransports(d, n), p = RTCRtpSender.getCapabilities(c),
                                f = [{ssrc: 1001 * (2 * n + 1)}];
        ...
        40: [function (e, t, n) {
            ...
            t.exports = function (e, t) {
                var n = new i;
                if (!o) return n;
                var t = t || {}, s = t.smoothing || .1, c = t.interval || 50, d = t.threshold, u = t.play,
                    p = t.history || 10, f = !0;
                a || (a = new o);
                var l, h, m;
        ...
        45: [function (t, n, r) {
            !function (t) {
                ...
                var i, o, a, s = {}.toString, c = "function" == typeof e && e.amd, d = "object" == typeof JSON && JSON,
                ...
                if (!n("json")) {
                    var f = "[object Function]", l = "[object Date]", h = "[object Number]", m = "[object String]",
                        g = "[object Array]", v = "[object Boolean]", y = n("bug-string-char-index");
                    if (!p) var w = Math.floor, b = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334],
                        C = function (e, t) {
        ...
        46: [function (e, t, n) {
            ...
            var o = e("util"), a = e("hark"), s = e("webrtcsupport"), c = e("getusermedia"), d = e("getscreenmedia"),
                u = e("wildemitter"), p = e("mediastream-gain"), f = e("mockconsole");
        ...
        47: [function (e, t, n) {
            (function (e) {
                ...
                var Re = 200, Oe = "__lodash_hash_undefined__", De = 9007199254740991, je = "[object Arguments]",
                    Me = "[object Array]", _e = "[object Boolean]", Ae = "[object Date]", Ie = "[object Error]",
                    Le = "[object Function]", Ne = "[object GeneratorFunction]", Be = "[object Map]",
                    Ue = "[object Number]", Fe = "[object Object]", Ge = "[object Promise]", ze = "[object RegExp]",
                    Ve = "[object Set]", Je = "[object String]", qe = "[object Symbol]", He = "[object WeakMap]",
                    We = "[object ArrayBuffer]", Xe = "[object DataView]", $e = "[object Float32Array]",
                    Ye = "[object Float64Array]", Ke = "[object Int8Array]", Ze = "[object Int16Array]",
                    Qe = "[object Int32Array]", et = "[object Uint8Array]", tt = "[object Uint8ClampedArray]",
                    nt = "[object Uint16Array]", rt = "[object Uint32Array]", it = /[\\^$.*+?()[\]{}|]/g, ot = /\w*$/,
                    at = /^\[object .+?Constructor\]$/, st = /^(?:0|[1-9]\d*)$/, ct = {};
                ...
                var dt = "object" == typeof e && e && e.Object === Object && e,
                    ...
                    pt = dt || ut || Function("return this")(), ft = "object" == typeof n && n && !n.nodeType && n,
                    lt = ft && "object" == typeof t && t && !t.nodeType && t, ht = lt && lt.exports === ft,
                    mt = Array.prototype, gt = Function.prototype, vt = Object.prototype, yt = pt["__core-js_shared__"],
                    wt = function () {
                        var e = /[^.]+$/.exec(yt && yt.keys && yt.keys.IE_PROTO || "");
                        return e ? "Symbol(src)_1." + e : ""
                    }(), bt = gt.toString, Ct = vt.hasOwnProperty, St = vt.toString,
                    kt = RegExp("^" + bt.call(Ct).replace(it, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"),
                    Tt = ht ? pt.Buffer : void 0, Et = pt.Symbol, Pt = pt.Uint8Array,
                    xt = f(Object.getPrototypeOf, Object), Rt = Object.create, Ot = vt.propertyIsEnumerable,
                    Dt = mt.splice, jt = Object.getOwnPropertySymbols, Mt = Tt ? Tt.isBuffer : void 0,
                    _t = f(Object.keys, Object), At = se(pt, "DataView"), It = se(pt, "Map"), Lt = se(pt, "Promise"),
                    Nt = se(pt, "Set"), Bt = se(pt, "WeakMap"), Ut = se(Object, "create"), Ft = me(At), Gt = me(It),
                    zt = me(Lt), Vt = me(Nt), Jt = me(Bt), qt = Et ? Et.prototype : void 0,
        ...
        49: [function (e, t, n) {
            ...
            var o = window.mozRTCPeerConnection || window.webkitRTCPeerConnection,
                ...
                u = window.AudioContext || window.webkitAudioContext, p = document.createElement("video"),
        ...
        57: [function (e, t, n) {
            ...
            var i = e("util"), o = e("sdp-jingle-json"), a = e("wildemitter"), s = e("traceablepeerconnection"),
                c = e("webrtc-adapter"), d = e("lodash.clonedeep");
            i.inherits(r, a), Object.defineProperty(r.prototype, "signalingState", {
                ...
                if (e.contents || e.jingle && e.jingle.contents) {
                    ...
                    i.forEach(function (e) {
                        var i = e.transport || {}, a = i.candidates || [], s = r.indexOf(e.name), c = e.name,
                ...
                var n = this, r = 2 === arguments.length,
                ...
                var n = 2 === arguments.length, r = n ? t : e,
                ...
                if (e.candidate) {
                    ...
                    var n = e.candidate,
                        r = {candidate: {candidate: n.candidate, sdpMid: n.sdpMid, sdpMLineIndex: n.sdpMLineIndex}};
        ...
        61: [function (e, t, n) {
            ...
            n._setIdCounter = function (e) {
                ...
                var r, o = t.creators || [], a = t.role || "initiator", s = t.direction || "outgoing",
                    c = e.split("\r\nm=");
                ...
                var a = o.creator || "initiator", s = o.role || "initiator", c = o.direction || "outgoing",
                    d = i.lines(e), u = i.lines(t), p = i.mline(d[0]), f = {
                        creator: a,
                        name: p.media,
                        application: {
                            applicationType: "rtp",
        ...
        62: [function (e, t, n) {
            ...
            n.toSessionSDP = function (e, t) {
                var r = (t.role || "initiator", t.direction || "outgoing", t.sid || e.sid || Date.now()),
                    i = t.time || Date.now(), o = ["v=0", "o=- " + r + " " + i + " IN IP4 0.0.0.0", "s=-", "t=0 0"],
                    a = e.contents || [], s = !1;
                a.forEach(function (e) {
                ...
                var i = [], o = t.role || "initiator", a = t.direction || "outgoing", s = e.application,
                    c = e.transport, d = s.payloads || [], u = c && c.fingerprints || [], p = [];
        ...
        63: [function (e, t, n) {
            ...
            r.generateIdentifier = function () {
                ...
                var i = n.filter(function (e) {
                    ...
                    o = {role: "auto", fingerprints: [{algorithm: i.split(" ")[0], value: i.split(" ")[1]}]};
                return o
                ...
                var t, n = [], i = r.parseRtpParameters(e), o = i.fecMechanisms.indexOf("RED") !== -1,
                    a = i.fecMechanisms.indexOf("ULPFEC") !== -1, s = r.matchPrefix(e, "a=ssrc:").map(function (e) {
                        return r.parseSsrcMedia(e)
                    }).filter(function (e) {
                        return "cname" === e.attribute
        ...
        66: [function (e, t, n) {
            ...
            var i = (e("./url"), e("engine.io-client")), o = e("./socket"), a = e("component-emitter"),
                s = e("socket.io-parser"), c = e("./on"), d = e("component-bind"),
                u = (e("object-component"), e("debug")("socket.io-client:manager")), p = e("indexof"), f = e("backo2");
        ...
        68: [function (e, t, n) {
            ...
            var i = e("socket.io-parser"), o = e("component-emitter"), a = e("to-array"), s = e("./on"),
                c = e("component-bind"), d = e("debug")("socket.io-client:socket"), u = e("has-binary");
            t.exports = n = r;
            var p = {
                connect: 1,
                connect_error: 1,
        ...
        71: [function (e, t, n) {
            ...
            var u = e("debug")("socket.io-parser"), p = e("json3"), f = (e("isarray"), e("component-emitter")),
                l = e("./binary"), h = e("./is-buffer");
        ...
        84: [function (t, n, r) {
            (function (t) {
                !function (i) {
                    ...
                    var h = "object" == typeof r && r, m = "object" == typeof n && n && n.exports == h && n,
                        g = "object" == typeof t && t;
                ...
                shimPeerConnection: function () {
                    ...
                    window.RTCPeerConnection = function (e) {
                        ...
                        var t = this, n = new MediaStream, i = [], o = r.splitSections(e.sdp), a = o.shift(),
                            s = r.matchPrefix(a, "a=ice-lite").length > 0;
                        switch (this.usingBundle = r.matchPrefix(a, "a=group:BUNDLE ").length > 0, o.forEach(function (o, c) {
                            var d = r.splitLines(o), u = d[0].substr(2).split(" "), p = u[0], f = "0" === u[1],
                                l = r.getDirection(o, a), h = r.matchPrefix(o, "a=mid:");
        ...
        98: [function (e, t, n) {
            ...
            t.exports = r, r.mixin = function (e) {
                ...
                t.isWildEmitter = !0, t.on = function (e, t, n) {
                    ...
                    this.callbacks = this.callbacks || {};
                    var t, n, r, i = [].slice.call(arguments, 1), o = this.callbacks[e],
        ...
        100: [function (e, t, n) {
            ...
            var o = e("util"), a = e("webrtcsupport"), s = e("rtcpeerconnection"), c = e("wildemitter"),
                d = e("filetransfer"), u = "https://simplewebrtc.com/protocol/filetransfer#inband-v1";
        ...
        101: [function (e, t, n) {
            ...
            var i = e("./webrtc"), o = e("wildemitter"), a = e("webrtcsupport"), s = e("attachmediastream"),
                c = e("mockconsole"), d = e("./socketioconnection");
            r.prototype = Object.create(o.prototype, {constructor: {value: r}}), r.prototype.leaveRoom = function () {
                ...
                var e = document.getElementById("localScreen"), t = this.getRemoteVideoContainer(),
