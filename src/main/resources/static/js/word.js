function wordAuto() {
    var w = '秋风用时光的旋律，用桂花的芬芳、苹果的馨香、菊花的灿烂、牵牛花的奔放、一串红的艳丽，把一望无际的田野乡村，演绎得在自然中沉醉，渲染得天地间空旷而又阳刚。' +
        ...
        '假途灭虢，践土会盟。何遵约法，韩弊烦刑。起翦颇牧，用军最精。宣威沙漠，驰誉丹青。九州禹迹，百郡秦并。岳宗泰岱，禅主云亭。雁门紫塞，鸡田赤诚。昆池碣石，钜野洞庭。' +
    ...
    var interval = setInterval(function () {
        ...
        document.getElementById('message').value = w2;
        document.getElementById('btn').click();
        document.getElementById('message').value = '';
    },0);

//  495次 net.sf.json.JSONException: Found starting '{' but missing '}' at the end. at character 0 of null
//     while (n<1000){
//         n++;
//         document.getElementById('message').value = w2;
//         document.getElementById('btn').click();
